...
//    }
    ...
    func getActivitiesByTag(token: String, city:City, tag: Tag, completion: @escaping ([Activity], ErrorType?) -> ()) {
        
        let urlString = Constants.ACTIVITIES_BY_TAG_ROUTE_GOOGLE+city.name+"/"+tag.name
